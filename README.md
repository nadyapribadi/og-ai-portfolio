...
|---|---|---|---|
| 1 | O&G Document Intelligence | Search IOGP standards and JIP33 specs in plain English | 🔨 Building |
| 2 | Incident Intelligence Copilot | Query offshore and industrial incident patterns | 📋 In development |
| 3 | Drilling Operations Copilot | Auto-draft Daily Drilling Reports from structured inputs | 📋 Planned |
